...
@Component({
  selector: 'ds-item-page-uri-custom-field',
  templateUrl: './item-page-uri-custom-field.component.html'
})
/**
 * This component can be used to represent any uri on a simple item page.
 * It expects 4 parameters: The item, a separator, the metadata keys and an i18n key
 */
export class ItemPageUriCustomFieldComponent extends ItemPageFieldComponent {
